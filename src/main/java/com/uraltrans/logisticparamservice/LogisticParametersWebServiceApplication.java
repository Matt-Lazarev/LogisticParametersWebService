...
//        List<Wagon> list = wagons.readAsList("Запрос расчета.xlsx", Wagon.class, null);
//
...
//            wagon.setType(wagon.getType().split(" ")[0]);
//            for(FlightTimeDistance ftd : allTimeDistances){
//                if(ftd.getDepartureStationCode().equalsIgnoreCase(wagon.getCode1()) && ftd.getDestinationStationCode().equals(wagon.getCode2()) && ftd.getTypeFlight().equals(wagon.getType()))
//                {
